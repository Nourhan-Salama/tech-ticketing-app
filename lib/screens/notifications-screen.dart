...
class _NotificationsScreenState extends State<NotificationsScreen> {
  ...
  Future<void> _navigateToTicketDetails(
    ...
    try {
      ...
      // Create minimal TicketModel from available data
      final userTicket = TicketModel(
        id: ticketDetails.id,
        title: ticketDetails.title,
        status: ticketDetails.status,
        description: ticketDetails.description,
        service: ServiceModel(id: 0, name: ticketDetails.serviceName),
        user: UserModel(id: 0, name: ticketDetails.userName),
        manager: ticketDetails.managerName != null
            ? ManagerModel(
                id: 0,
                user: UserModel(id: 0, name: ticketDetails.managerName!),
              )
            : null,
        technician: ticketDetails.technicianName != null
            ? TechnicianModel(
                id: 0,
                user: UserModel(id: 0, name: ticketDetails.technicianName!),
              )
            : null,
      );
